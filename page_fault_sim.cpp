...
void simulatePageFaultsWithMatrix(size_t matrixSize) {
    ...
    // Simula acesso aos elementos para gerar page faults
...
void randomAccessMatrix(size_t matrixSize) {
    ...
    // Acessa elementos aleatórios na matriz para gerar page faults
...
int main() {
    ...
    // Chama as funções para simular page faults
